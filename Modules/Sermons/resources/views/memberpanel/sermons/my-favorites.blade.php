    ...
    @if($favorites->count() > 0)
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach($favorites as $favorite)
                ...
                <a href="{{ route('painel.sermons.show', $sermon) }}" class="group bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-xl hover:border-pink-500/30 dark:hover:border-pink-500/30 transition-all duration-300 flex flex-col h-full hover:-translate-y-1">
                    <!-- Card Header -->
