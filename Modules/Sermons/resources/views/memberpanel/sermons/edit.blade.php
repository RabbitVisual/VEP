        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="flex items-center justify-between">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('painel.sermons.my-sermons') }}"
                        class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 text-sm font-medium rounded-xl text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700">
            ...
            <form id="sermon-form" action="{{ route('painel.sermons.update', $sermon) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="flex items-center justify-end gap-3 pb-8">
                    ...
                    @endif
                    <a href="{{ route('painel.sermons.show', $sermon) }}" class="px-6 py-3 border border-gray-300 dark:border-gray-600 text-sm font-medium rounded-xl text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700">Cancelar</a>
            ...
            @if($sermon->canDelete(auth()->user()))
            <form id="delete-form" action="{{ route('painel.sermons.destroy', $sermon) }}" method="POST" class="hidden">
                @csrf
                @method('DELETE')
            </form>
            @endif
