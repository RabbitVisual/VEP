...
(function () {
    ...
    function init() {
        ...
        new TagManager();
        new SermonEditor();
        // @mention autocomplete for Bible references (Tribute.js)
        import('./mention-autocomplete.js').then((m) => {
            if (typeof m.initBibleMentionAutocomplete === 'function') {
                m.initBibleMentionAutocomplete();
            }
        }).catch(() => {});
    }
