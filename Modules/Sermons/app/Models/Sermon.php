...
class Sermon extends Model
{
    ...
    /**
     * Get the worship suggestion (requer módulo Worship).
     */
    public function worshipSuggestion(): BelongsTo
    {
        $class = \VertexSolutions\Worship\App\Models\WorshipSong::class;
        if (class_exists($class)) {
            return $this->belongsTo($class, 'worship_suggestion_id');
        }
        return $this->belongsTo(\VertexSolutions\Sermons\Models\WorshipSongStub::class, 'worship_suggestion_id');
    }
    ...
    {
        return $this->belongsToMany(SermonTag::class, 'sermon_has_tags', 'sermon_id', 'tag_id');
    }
