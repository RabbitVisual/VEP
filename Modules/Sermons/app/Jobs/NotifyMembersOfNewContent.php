...
namespace VertexSolutions\Sermons\Jobs;
...
use App\Models\User;
use VertexSolutions\Notifications\App\Notifications\SystemNotification;
...
class NotifyMembersOfNewContent implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $notificationData = [
            ...
            'action_url' => route('painel.sermons.show', $this->sermon->id),
            'type' => 'info',
            'icon' => 'book-open'
        ];
