...
use VertexSolutions\Core\Models\BibleMetadata;
use VertexSolutions\Core\Models\BiblePlan;
use VertexSolutions\Core\Models\BiblePlanContent;
use VertexSolutions\Core\Models\BiblePlanDay;
use VertexSolutions\Core\Models\Book;
...
class PlanGeneratorEngine
{
    ...
    public function generateFromTemplate(BiblePlan $plan, string $templateType, int $versionId)
    {
        ...
        $chaptersData = \VertexSolutions\Core\Models\Chapter::whereIn('book_id', array_values($booksMap))
            ->get()
            ->groupBy('book_id');
