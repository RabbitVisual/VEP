...
return [
    ...
    */
    ...
    // Deixe vazio ou remova OPENAI_ORGANIZATION no .env se usar chave pessoal (sem organização).
    // Só defina se sua API key pertencer a uma organização (ex.: org-xxx no dashboard OpenAI).
