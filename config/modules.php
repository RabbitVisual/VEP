...
return [
    ...
    */
    'composer' => [
        'vendor' => env('MODULE_VENDOR', 'vertexsolutions'),
        'author' => [
            'name' => env('MODULE_AUTHOR_NAME', 'Reinan Rodrigues'),
            'email' => env('MODULE_AUTHOR_EMAIL', 'r.rodriguesjs@gmail.com'),
        ],
        'company' => env('MODULE_COMPANY', 'Vertex Solutions LTDA.'),
        'copyright' => env('MODULE_COPYRIGHT', '© 2026 Vertex Solutions LTDA'),
        'version' => env('MODULE_VERSION', 'vs.1.0.0'),
